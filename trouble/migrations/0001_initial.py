    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Any notes for this item', verbose_name='description')),
                ...
                ('item', models.ForeignKey(blank=True, help_text='The item associated with this ticket', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ticket', to='inventory.Item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_reported', models.DateField(auto_now_add=True, help_text='The date this ticket was submitted', verbose_name='date')),
                ('ticket', models.ForeignKey(help_text='The ticket for this update', on_delete=django.db.models.deletion.CASCADE, related_name='update', to='trouble.Ticket')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderby1', models.CharField(choices=[('submitter', 'Submitter'), ('-submitter', 'Submitter DESC'), ('item', 'Item'), ('-item', 'Item DESC'), ('impact', 'Impact'), ('-impact', 'Impact DESC'), ('date_reported', 'Date'), ('-date_reported', 'Date DESC')], default='item', max_length=20, verbose_name='order by')),
                ('orderby2', models.CharField(choices=[('submitter', 'Submitter'), ('-submitter', 'Submitter DESC'), ('item', 'Item'), ('-item', 'Item DESC'), ('impact', 'Impact'), ('-impact', 'Impact DESC'), ('date_reported', 'Date'), ('-date_reported', 'Date DESC')], default='inventory', max_length=20, verbose_name='order by')),
                ('orderby3', models.CharField(choices=[('submitter', 'Submitter'), ('-submitter', 'Submitter DESC'), ('item', 'Item'), ('-item', 'Item DESC'), ('impact', 'Impact'), ('-impact', 'Impact DESC'), ('date_reported', 'Date'), ('-date_reported', 'Date DESC')], default='condition', max_length=20, verbose_name='order by')),
