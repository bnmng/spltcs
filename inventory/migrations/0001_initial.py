    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('familiar_name_operator', models.CharField(choices=[('familiar_name__iexact', 'equals'), ('familiar_name__icontains', 'contains')], default='familiar_name__icontains', max_length=50, verbose_name='familiar_name operator')),
                ...
                ('serial_number_operator', models.CharField(choices=[('serial_number__iexact', 'equals'), ('serial_number__icontains', 'contains')], default='serial_number__icontains', max_length=50, verbose_name='serial_number operator')),
                ('makemodel_use', models.BooleanField(default=False, verbose_name='use model')),
                ('makemodel_operator', models.CharField(choices=[('makemodel__iexact', 'equals'), ('makemodel__icontains', 'contains')], default='makemodel__icontains', max_length=50, verbose_name='makemodel operator')),
                ...
                ('asset_number_operator', models.CharField(choices=[('asset_number__iexact', 'equals'), ('asset_number__icontains', 'contains')], default='asset_number__icontains', max_length=50, verbose_name='asset_number operator')),
                ...
                ('barcode_operator', models.CharField(choices=[('barcode__iexact', 'equals'), ('barcode__icontains', 'contains')], default='barcode__icontains', max_length=50, verbose_name='barcode operator')),
                ...
                ('hostname_operator', models.CharField(choices=[('hostname__iexact', 'equals'), ('hostname__icontains', 'contains')], default='hostname__icontains', max_length=50, verbose_name='hostname operator')),
                ('roles_use', models.BooleanField(default=False, verbose_name='use roles')),
                ('roles_operator', models.CharField(choices=[('roles__in', 'are in')], default='roles__in', max_length=50, verbose_name='roles operator')),
                ('home_use', models.BooleanField(default=False, verbose_name='use home')),
                ('home_operator', models.CharField(choices=[('home__exact', 'equals')], default='home__exact', max_length=50, verbose_name='home operator')),
                ('location_use', models.BooleanField(default=False, verbose_name='use location')),
                ('location_operator', models.CharField(choices=[('location__iexact', 'equals'), ('location__icontains', 'contains')], default='location__icontains', max_length=50, verbose_name='location operator')),
                ...
                ('condition_operator', models.CharField(choices=[('condition__iexact', 'equals'), ('condition__icontains', 'contains')], default='condition__icontains', max_length=50, verbose_name='condition operator')),
                ...
                ('inventory_operator', models.CharField(choices=[('inventory__iexact', 'equals'), ('inventory__icontains', 'contains')], default='inventory__icontains', max_length=50, verbose_name='inventory operator')),
                ('keeper_use', models.BooleanField(default=False, verbose_name='use keeper')),
                ('keeper_operator', models.CharField(choices=[('keeper__iexact', 'equals'), ('keeper__icontains', 'contains')], default='keeper__icontains', max_length=50, verbose_name='keeper operator')),
                ('borrower_use', models.BooleanField(default=False, verbose_name='use borrower')),
                ('borrower_operator', models.CharField(choices=[('borrower__iexact', 'equals'), ('borrower__icontains', 'contains')], default='borrower__icontains', max_length=50, verbose_name='borrower operator')),
                ('lessor_use', models.BooleanField(default=False, verbose_name='use lessor')),
                ('lessor_operator', models.CharField(choices=[('lessor__iexact', 'equals'), ('lessor__icontains', 'contains')], default='lessor__icontains', max_length=50, verbose_name='lessor operator')),
                ...
                ('notes_operator', models.CharField(choices=[('notes__iexact', 'equals'), ('notes__icontains', 'contains')], default='notes__icontains', max_length=50, verbose_name='notes operator')),
